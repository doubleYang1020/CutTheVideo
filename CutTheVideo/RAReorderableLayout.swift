...
//  func getCurrentCell(at indexPath: IndexPath) -> UICollectionViewCell? {
//    print("getCurrentCell")
//    let cell = self.collectionView?.cellForItem(at: indexPath)
//    if cell == nil {
//      return self.getCurrentCell(at: indexPath)
//    }else{
//      return cell
//    }
//    
...
private class RACellFakeView: UIView {
    ...
    init(cell: UICollectionViewCell) {
        ...
        cellFakeImageView = UIImageView(frame: CGRect.init(x: 2, y: 2, width: 50, height: 46))
        ...
        cellFakeHightedView = UIImageView(frame: CGRect.init(x: 2, y: 2, width: 50, height: 46))
        ...
        cellFakeHightedView?.image = image
        cellFakeHightedView?.clipsToBounds = true
        cell.isHighlighted = false
        cellFakeImageView?.image = image
        cellFakeImageView?.clipsToBounds = true
...
//                self.transform = CGAffineTransform(scaleX: 1.1, y: 1.1)
                ...
                let newFrame = CGRect.init(x: self.cellFrame!.origin.x, y: self.cellFrame!.origin.y, width: 54, height: 50)
